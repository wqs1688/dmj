...
class Page
{
	...
	public function GetPageHtml()
	{
		...
		$this->html .= '&nbsp;&nbsp;&nbsp;<span>'.lang('common_page_text1').'</span>';
		...
		$this->html .= '<span>'.lang('common_page_text2').'</span>';

		$this->html .= '<div>';
		$this->html .= '<span>'.lang('common_page_text4').' '.$this->total.' '.lang('common_page_text3').'</span>';
		$this->html .= '&nbsp;&nbsp;&nbsp;<span>'.lang('common_page_text4').' '.$this->page_total.' '.lang('common_page_text2').'</span>';
		$this->html .= '</div>';
		$this->html .= '</ul>';
