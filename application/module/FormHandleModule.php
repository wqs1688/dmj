...
class FormHandleModule
{
                ...
                if(!empty($v['search_config']['form_name']))
                {
                    ...
                    switch($v['search_config']['form_type'])
                    {
                        ...
                        case 'input' :
                            ...
                            {
                                $v['search_config']['placeholder'] = lang('common_handle_text1').$label;
                            }
                            break;
                        ...
                        case 'select' :
                            ...
                            if(empty($v['search_config']['placeholder']))
                            {
                                $v['search_config']['placeholder'] = lang('common_handle_text2').$label;
                            }
                        ...
                        case 'section' :
                            ...
                            {
                                $v['search_config']['placeholder_min'] = lang('common_handle_text3');
                            }
                            if(empty($v['search_config']['placeholder_max']))
                            {
                                $v['search_config']['placeholder_max'] = lang('common_handle_text4');
                            }
                            break;
                        ...
                        case 'date' :
                            ...
                            {
                                $v['search_config']['placeholder_start'] = lang('common_handle_text5');
                            }
                            if(empty($v['search_config']['placeholder_end']))
                            {
                                $v['search_config']['placeholder_end'] = lang('common_handle_text6');
                            }
                            break;
                    }
    ...
    public function FormBaseLastHandle()
    {
        ...
        if(isset($this->form_data['base']['is_delete']) && $this->form_data['base']['is_delete'] == 1)
        {
            ...
            {
                $this->form_data['base']['confirm_title'] = lang('common_confirm_title');
            }
            if(empty($this->form_data['base']['confirm_msg']))
            {
                $this->form_data['base']['confirm_msg'] = lang('common_confirm_msg');
            }
            if(empty($this->form_data['base']['confirm_sure']))
            {
                $this->form_data['base']['confirm_sure'] = lang('common_confirm_sure');
            }
            if(empty($this->form_data['base']['confirm_cancel']))
            {
                $this->form_data['base']['confirm_cancel'] = lang('common_confirm_cancel');
            }
        }
    }
