...
return [
	...
	// 后台共通头部
	'common_admin_nav_title'        => "首页",
	'admin_theme_site_name'         => "大麦家",
	'common_admin_title'            => "后台管理系统",
	'common_admin_title_1'          => "查看首页",
	'common_admin_title_2'          => "开启全屏",
	'common_admin_title_3_1'        => "设置",
	'common_admin_title_3_2'        => "退出",
	'common_admin_title_4'          => "语言选择",
	'common_admin_init_stat'         => "商城统计",
	'common_admin_init_stat_user'    => "用户总量",
	'common_admin_init_date1'        => "上月",
	'common_admin_init_date2'        => "当月",
	'common_admin_init_date3'        => "昨日",
	'common_admin_init_date4'        => "今日",
	'common_admin_init_stat_order'   => "订单总量",
	'common_admin_init_stat_deal'    => "成交总量",
	'common_admin_init_stat_inco'    => "收入总量",
	'common_admin_init_deal_trend'   => "近30日订单成交金额走势",
	'common_admin_init_order_trend'  => "近30日订单交易走势",
	'common_admin_init_hot_product'  => "近30日热销商品",
	'common_admin_init_pay'          => "近30日支付方式",
	'common_admin_config_title1'     => "基础配置",
	'common_admin_config_title2'     => "登录",
	'common_admin_config_title3'     => "商品",
	'common_admin_config_title4'     => "扩展",
	'common_admin_config_comment1'   => "1. 默认背景图片位于[ public/static/admin/default/images/login ]目录下",
	'common_admin_config_comment2'   => "2. 变更图片后、需要在[ application/admin/controller/Admin.php ]文件中[ LoginInfo ]方法中修改[ bg_images_list ]变量",
	'common_admin_config_comment3'   => "请到百度地图开放平台申请",
	'common_admin_config_comment4'   => "查看配置教程",
	'common_admin_config_comment5'   => "保存",
	'common_admin_config_comment6'   => "选择图片",
    'common_page_text1'              => "跳转到",
    'common_page_text2'              => "页",
    'common_page_text3'              => "条数据",
    'common_page_text4'              => "共",
	...
	'common_handle_text1'               => '请输入',
    'common_handle_text2'               => '请选择',
    'common_handle_text3'               => '最小值',
    'common_handle_text4'               => '最大值',
    'common_handle_text5'               => '开始',
    'common_handle_text6'               => '结束',

    'common_confirm_title'              => '温馨提示',
    'common_confirm_msg'                => '删除后不可恢复,确认操作吗?',
    'common_confirm_sure'               => '取消',
    'common_confirm_cancel'             => '确定',
];
?>
