...
class UserService
{
    ...
    public static function UserList($params = [])
    {
        ...
        if(!empty($data))
        {
            ...
            foreach($data as &$v)
            {
                ...
                $params['where'] = ['id'=>$v['warehouse_id'],'is_delete_time'=>'0'];
                $ret = WarehouseService::getWarehouses($params);
    ...
    public static function UserSave($params = [])
    {
        ...
        $data = [
            ...
            'warehouse_id'               => isset($params['area_id']) ? $params['area_id'] :  1,
            'upd_time'              => time(),
        ];
    ...
    public static function UserInsert($data, $params = [])
    {
		...
		// 海外仓区域
		$data['warehouse_id'] = isset($params['area'])?$params['area']:1;
